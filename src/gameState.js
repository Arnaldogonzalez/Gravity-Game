var gameState = function(game){
    ...
    var preload = function(){
        ...
        game.load.image('evil_ball', 'images/evil_ball.png');
    }
    ...
    var create = function(){
        ...
        for(i = 0; i < 15; i++){
            var evil = evilBalls.create(game.world.randomX, Math.random()*380, 'evil_ball');
            var controller = new evilBallController(evil);
